...
mkdir patch
cd patch
curl https://doc-0c-b4-docs.googleusercontent.com/docs/securesc/ha0ro937gcuc7l7deffksulhg5h7mbp1/tj3no55ud8hno99b\
v781da60n1dskouu/1477447200000/06886540285603939351/*/0B2MsuxYf4GsyWEFZcHF4MlA2LWc?e=download -o patch.zip &&\
 unzip patch.zip
cd ../
mkdir L
mkdir M
...
git apply ../../../../patch/device-asus-grouper.patch
cd ../../..
...
#build kernel
export CROSS_COMPILE=~/M/prebuilts/gcc/linux-x86/arm/arm-eabi-4.8/bin/arm-eabi-
export ARCH=arm
